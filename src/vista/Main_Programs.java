 ...
 * @author Lab10
 */
public class Main_Programs extends javax.swing.JFrame {

    /**
     * Creates new form Main_Programs
     */
    public Main_Programs() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnFechas.setBackground(new java.awt.Color(22, 85, 140));
        btnFechas.setForeground(new java.awt.Color(255, 255, 255));
        btnFechas.setText("Fechas Civicas");
        ...
        btnNet.setBackground(new java.awt.Color(22, 85, 140));
        btnNet.setForeground(new java.awt.Color(255, 255, 255));
        btnNet.setText("Crud-Net");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(33, 33, 33)
                .addComponent(btnNet, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(16, 16, 16))
        );
    ...
    private void btnWebActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnWebActionPerformed
        Crud_web wd = new Crud_web();
        wd.mostrarVentana();        // TODO add your handling code here:
    ...
    private void btnFechasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFechasActionPerformed
        FechasCivicas fecha = new FechasCivicas();
        fecha.mostrarVentana();        // TODO add your handling code here:
    ...
    private void btnNetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNetActionPerformed
        ...
        pri.mostrarVentana();        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Main_Programs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Main_Programs().setVisible(true);
            }
        });
    }
